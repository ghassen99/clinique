                        ...
                        if($val['DATA_TYPE'] == 'date'){
                            ...
                            foreach($requete2 as $vr){
                                ...
                                if (($vr->COLUMN_NAME == $val['COLUMN_NAME'])){
                                    $find=1;
                                    $tab_referencee = $vr->REFERENCED_TABLE_NAME;
                                ...
                                <div class="item form-group">
                                    ...
                                    <span class="col-md-6">
                                        ...
                                        <?php
                                        foreach($res_'.$tab_referencee.' as $obj){
        ...
        <div class="row">
            ...
            <div class="x_panel">
                ...
                if ($i==0){
                    ...
                    <div class="item form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $res_'.$res[0].'->'.$val['COLUMN_NAME'].'; ?>" id="'.$val['COLUMN_NAME'].'" class="form-control col-md-7 col-xs-12" data-validate-length-range="30" name="'.$val['COLUMN_NAME'].'" placeholder="'.$val['COLUMN_NAME'].'" required="required" style="display:none" type="text">
                        </div>
                    </div>
                ';
                ...
                <div class="item form-group">
                    ...
                    <span class="col-md-6">
                        ...
                        <?php
                        foreach($res_'.$tab_referencee.' as $obj){
                            if ($res_'.$res[0].'->'.$val['COLUMN_NAME'].' == $obj->'.$col.') // on va comparer id du table mere avec id de la table fille, et lorsqu\'il sont identique on ajoute "selected" 
                                echo "<option value=".$obj->'.$col.'." selected>".$obj->'.$col.'."</options>"; 
                            else
                                echo "<option value=".$obj->'.$col.'.">".$obj->'.$col.'."</options>";  
                        }
                        ?>
            ...
            ';
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input value="<?php echo $res_'.$res[0].'->'.$val['COLUMN_NAME'].'; ?>" id="'.$val['COLUMN_NAME'].'" class="form-control col-md-7 col-xs-12" data-validate-length-range="30" name="'.$val['COLUMN_NAME'].'" placeholder="'.$val['COLUMN_NAME'].'" required="required" type="text">
                        </div>
                    </div>
                ';
                                }
